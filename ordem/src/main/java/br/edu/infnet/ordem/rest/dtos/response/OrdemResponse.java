...
public class OrdemResponse {
	...
	@ApiModelProperty(notes = "Usuário da ordem de serviço.", example = "1", required = true, position = 3)
	@NotNull(message = "O id do usuário é necessário.")
	private Long usuarioId;

	@ApiModelProperty(notes = "Cliente da ordmem de serviço.", example = "1", required = true, position = 4)
